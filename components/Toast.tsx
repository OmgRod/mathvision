...
export const Toast: React.FC<ToastProps> = ({ achievement, onClose }) => {
  return (
    ...
    >
      <div className="bg-slate-900 text-white p-6 rounded-[2.5rem] shadow-2xl border border-white/10 flex items-center gap-5 relative overflow-hidden">
        ...
        <div className="flex-grow space-y-1 relative z-10">
          <div className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Achievement Unlocked!</div>
          ...
          <div className="inline-block mt-2 px-3 py-1 bg-white/10 rounded-full text-[10px] font-black text-emerald-400">
