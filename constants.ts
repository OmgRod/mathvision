...
export const PRACTICE_TOPICS: MathTopic[] = [
  ...
  { name: "Place Value and Rounding", category: "Arithmetic", level: "Primary", description: "Understanding digits and rounding to powers of 10", exams: ["11+ / Primary Excellence"] },
  { name: "Long Addition and Subtraction", category: "Arithmetic", level: "Primary", description: "Column methods for large numbers", exams: ["11+ / Primary Excellence"] },
  { name: "Long Multiplication", category: "Arithmetic", level: "Middle School", description: "Multiplying multi-digit integers", exams: ["11+ / Primary Excellence", "13+ / Scholarship Track"] },
  { name: "Short and Long Division", category: "Arithmetic", level: "Middle School", description: "Division algorithms including remainders", exams: ["11+ / Primary Excellence", "13+ / Scholarship Track"] },
  { name: "Order of Operations (BIDMAS/PEMDAS)", category: "Arithmetic", level: "Middle School", description: "Evaluating expressions with brackets, indices, and mixed operators", exams: ["11+ / Primary Excellence", "13+ / Scholarship Track", "SAT Math"] },
  { name: "Negative Number Arithmetic", category: "Arithmetic", level: "Middle School", description: "Operations with positive and negative integers", exams: ["13+ / Scholarship Track", "SAT Math"] },
  { name: "Fraction Simplification", category: "Arithmetic", level: "Middle School", description: "Finding equivalent fractions and simplest forms", exams: ["11+ / Primary Excellence", "13+ / Scholarship Track"] },
  { name: "Adding and Subtracting Fractions", category: "Arithmetic", level: "Middle School", description: "Working with common denominators", exams: ["11+ / Primary Excellence", "13+ / Scholarship Track", "SAT Math"] },
  { name: "Multiplying and Dividing Fractions", category: "Arithmetic", level: "Middle School", description: "Fractional operations and reciprocal methods", exams: ["11+ / Primary Excellence", "13+ / Scholarship Track", "SAT Math"] },
  { name: "Mixed Numbers and Improper Fractions", category: "Arithmetic", level: "Middle School", description: "Converting between different fraction representations", exams: ["11+ / Primary Excellence", "13+ / Scholarship Track"] },
  { name: "Percentage of an Amount", category: "Arithmetic", level: "Middle School", description: "Calculating 10%, 25%, 17.5%, etc.", exams: ["SAT Math", "11+ / Primary Excellence", "13+ / Scholarship Track"] },
  { name: "FDP Conversions", category: "Arithmetic", level: "Middle School", description: "Converting between Fractions, Decimals, and Percentages", exams: ["11+ / Primary Excellence", "13+ / Scholarship Track", "SAT Math"] },
  ...
  { name: "Ratio Sharing", category: "Arithmetic", level: "Middle School", description: "Dividing quantities into parts", exams: ["SAT Math", "11+ / Primary Excellence", "13+ / Scholarship Track"] },
  ...
  { name: "Solving Linear Equations", category: "Algebra", level: "Middle School", description: "Step-by-step isolation of variables", exams: ["SAT Math", "13+ / Scholarship Track", "GCSE Maths Higher"] },
  ...
  { name: "Rearranging Formulas (Subject of)", category: "Algebra", level: "GCSE", description: "Changing the subject of a given formula", exams: ["GCSE Maths Higher", "SAT Math"] },
  { name: "Linear Inequalities (Solving)", category: "Algebra", level: "GCSE", description: "Solving and graphing 1D inequalities", exams: ["SAT Math", "GCSE Maths Higher"] },
  { name: "Quadratic Graphs (Drawing)", category: "Algebra", level: "GCSE", description: "Plotting parabolas and identifying features", exams: ["GCSE Maths Higher", "SAT Math"] },
  { name: "Factoring Quadratics (a=1)", category: "Algebra", level: "GCSE", description: "Factoring trinomials like x^2 + 5x + 6", exams: ["SAT Math", "GCSE Maths Higher"] },
  { name: "Difference of Two Squares", category: "Algebra", level: "GCSE", description: "Factoring x^2 - y^2 patterns", exams: ["GCSE Maths Higher", "SAT Math"] },
  { name: "Factoring Quadratics (a>1)", category: "Algebra", level: ["GCSE Higher", "AQA GCSE Further Maths"], description: "Advanced factoring using split-middle-term", exams: ["AQA GCSE Further Maths", "GCSE Maths Higher"] },
  { name: "Solving Quadratics by Factoring", category: "Algebra", level: "GCSE", description: "Finding roots using the zero product property", exams: ["SAT Math", "GCSE Maths Higher"] },
  { name: "The Quadratic Formula", category: "Algebra", level: "High School", description: "Solving roots when integers don't work", exams: ["SAT Math", "GCSE Maths Higher"] },
  { name: "Completing the Square", category: "Algebra", level: "High School", description: "Converting to vertex form: (x-h)^2 + k", exams: ["AQA GCSE Further Maths", "SAT Math", "GCSE Maths Higher"] },
  { name: "Algebraic Fractions: Addition", category: "Algebra", level: "A-Level", description: "Finding common algebraic denominators", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "Algebraic Long Division", category: "Algebra", level: "A-Level", description: "Dividing polynomials of higher degrees", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "The Factor Theorem", category: "Algebra", level: "A-Level", description: "Using division to find roots and factors", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "The Remainder Theorem", category: "Algebra", level: "A-Level", description: "Determining remainders without full division", exams: ["A-Level Further Maths"] },
  { name: "Binomial Expansion (Positive n)", category: "Algebra", level: ["High School", "AQA GCSE Further Maths"], description: "Expanding (a+b)^n for whole numbers", exams: ["AQA GCSE Further Maths", "A-Level Further Maths"] },
  { name: "Binomial Expansion (Negative/Fractional n)", category: "Algebra", level: "A-Level", description: "Infinite series expansions", exams: ["A-Level Further Maths"] },
  { name: "Partial Fractions: Distinct Roots", category: "Algebra", level: "A-Level", description: "Splitting fractions with different linear factors", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "Partial Fractions: Repeated Roots", category: "Algebra", level: "A-Level", description: "Splitting fractions with squaring factors", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "Laws of Logarithms", category: "Algebra", level: ["High School", "AQA GCSE Further Maths"], description: "Log addition, subtraction, and power rules", exams: ["AQA GCSE Further Maths", "A-Level Further Maths", "University STEM Foundation"] },
  { name: "Change of Base (Logs)", category: "Algebra", level: ["A-Level", "AQA GCSE Further Maths"], description: "Switching between log bases for solving", exams: ["AQA GCSE Further Maths", "A-Level Further Maths"] },
  { name: "Natural Logarithms (ln x)", category: "Algebra", level: "A-Level", description: "Solving equations involving e^x", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "The Discriminant (b^2 - 4ac)", category: "Algebra", level: "A-Level", description: "Predicting the number of real roots", exams: ["A-Level Further Maths", "GCSE Maths Higher"] },
  ...
  { name: "Introduction to Limits", category: "Calculus", level: "High School", description: "Approaching values from left and right", exams: ["AP Calculus AB", "A-Level Further Maths", "University STEM Foundation"] },
  { name: "Differentiation: Power Rule", category: "Calculus", level: "High School", description: "Finding the gradient of x^n", exams: ["AP Calculus AB", "A-Level Further Maths", "University STEM Foundation", "GCSE Maths Higher"] },
  { name: "Differentiating Trig Functions", category: "Calculus", level: "A-Level", description: "Derivatives of sin, cos, and tan", exams: ["AP Calculus AB", "A-Level Further Maths", "University STEM Foundation"] },
  ...
  { name: "Implicit Differentiation", category: "Calculus", level: "A-Level", description: "Equations where y is not isolated", exams: ["AP Calculus AB", "A-Level Further Maths", "University STEM Foundation"] },
  { name: "Parametric Differentiation", category: "Calculus", level: "A-Level", description: "Working with t as a separate parameter", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "Second Derivatives and Convexity", category: "Calculus", level: "A-Level", description: "Finding points of inflection", exams: ["AP Calculus AB", "A-Level Further Maths"] },
  ...
  { name: "Integration by Substitution", category: "Calculus", level: "A-Level", description: "Reverse chain rule using u-variable", exams: ["AP Calculus AB", "A-Level Further Maths", "University STEM Foundation"] },
  { name: "Integration by Parts", category: "Calculus", level: "A-Level", description: "Integrating products of functions", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "Integration by Partial Fractions", category: "Calculus", level: "A-Level", description: "Using algebraic splits for easy integration", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "Volume of Revolution", category: "Calculus", level: "A-Level", description: "3D volumes created by rotating functions", exams: ["A-Level Further Maths"] },
  { name: "The Trapezium Rule", category: "Calculus", level: "A-Level", description: "Numerical integration approximations", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "Newton-Raphson Method", category: "Calculus", level: "A-Level", description: "Iteration for finding numeric roots", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "First Order ODEs (Separable)", category: "Calculus", level: "University", description: "Solving diff equations by separating variables", exams: ["University STEM Foundation"] },
  ...
  { name: "Area of 2D Shapes", category: "Geometry", level: "Primary", description: "Triangles, rectangles, and parallelograms", exams: ["11+ / Primary Excellence", "13+ / Scholarship Track", "SAT Math"] },
  { name: "Area of Trapezia", category: "Geometry", level: "Middle School", description: "Using the formula (a+b)/2 * h", exams: ["13+ / Scholarship Track", "SAT Math", "GCSE Maths Higher"] },
  { name: "Circle Area and Circumference", category: "Geometry", level: "Middle School", description: "Calculations with Pi and radius", exams: ["11+ / Primary Excellence", "13+ / Scholarship Track", "SAT Math", "GCSE Maths Higher"] },
  { name: "Sector Area and Arc Length", category: "Geometry", level: "GCSE Higher", description: "Portions of circles in degrees or radians", exams: ["GCSE Maths Higher", "SAT Math"] },
  { name: "Pythagoras' Theorem (2D)", category: "Geometry", level: "Middle School", description: "Relationship between sides in right triangles", exams: ["13+ / Scholarship Track", "SAT Math", "GCSE Maths Higher"] },
  ...
  { name: "Mean, Median, and Mode", category: ["Statistics", "AQA GCSE Further Maths"], level: "Primary", description: "Basic central tendencies", exams: ["11+ / Primary Excellence", "13+ / Scholarship Track", "SAT Math", "GCSE Maths Higher"] },
  { name: "Range and Interquartile Range", category: "Statistics", level: "Middle School", description: "Measures of spread", exams: ["13+ / Scholarship Track", "SAT Math", "GCSE Maths Higher"] },
  { name: "Box and Whisker Plots", category: "Statistics", level: "GCSE", description: "Visualizing five-number summaries", exams: ["GCSE Maths Higher", "SAT Math"] },
  { name: "Scatter Graphs and Correlation", category: "Statistics", level: "Middle School", description: "Trend lines and relationship types", exams: ["13+ / Scholarship Track", "SAT Math", "GCSE Maths Higher"] },
  { name: "Probability Trees (Independent)", category: ["Probability", "Statistics"], level: ["GCSE", "AQA GCSE Further Maths"], description: "Successive events with fixed odds", exams: ["GCSE Maths Higher", "SAT Math", "AQA GCSE Further Maths"] },
  { name: "Conditional Probability (Dependent)", category: ["Probability", "Statistics"], level: ["GCSE Higher", "AQA GCSE Further Maths"], description: "Odds that change based on previous outcomes", exams: ["GCSE Maths Higher", "AQA GCSE Further Maths"] },
  { name: "Venn Diagrams for Probability", category: "Probability", level: "GCSE Higher", description: "Union, intersection, and complement", exams: ["GCSE Maths Higher", "SAT Math"] },
  { name: "Cumulative Frequency Curves", category: "Statistics", level: "GCSE Higher", description: "Estimating medians from curves", exams: ["GCSE Maths Higher"] },
  { name: "Histograms (Frequency Density)", category: "Statistics", level: "GCSE Higher", description: "Continuous data with unequal width bars", exams: ["GCSE Maths Higher"] },
  ...
  { name: "Intro to Matrices (Addition/Subtraction)", category: ["Matrices", "Algebra"], level: ["GCSE Higher", "AQA GCSE Further Maths"], description: "Basic matrix size and operations", exams: ["AQA GCSE Further Maths", "A-Level Further Maths"] },
  { name: "Matrix Multiplication (2x2)", category: ["Matrices", "Computing"], level: ["GCSE Higher", "AQA GCSE Further Maths"], description: "Dot products of rows and columns", exams: ["AQA GCSE Further Maths", "A-Level Further Maths"] },
  { name: "Determinant of 2x2 and 3x3 Matrices", category: "Matrices", level: "A-Level", description: "Calculating the 'volume' factor", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "Inverse of 2x2 Matrices", category: "Matrices", level: "A-Level", description: "Solving AX=B problems", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "2D Transformations (Rotation/Reflections)", category: "Matrices", level: ["GCSE Higher", "AQA GCSE Further Maths"], description: "Using matrices to warp shapes", exams: ["AQA GCSE Further Maths", "A-Level Further Maths"] },
  ...
  // --- COMPLEX NUMBERS ---
  { name: "Intro to i (Imaginary Numbers)", category: "Complex Numbers", level: "High School", description: "Square roots of negatives", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "Argand Diagrams", category: "Complex Numbers", level: "High School", description: "Plotting complex numbers as vectors", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "Complex Conjugates", category: "Complex Numbers", level: "High School", description: "Division of complex fractions", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "Modulus and Argument Form", category: "Complex Numbers", level: "A-Level", description: "Polar representation of complex numbers", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  ...
  { name: "Basic Measurement and Units", category: "Physics", level: "Primary", description: "Using rulers, scales, and clocks; understanding length, mass, time, and simple unit conversions", exams: ["11+ / Primary Excellence"] },
  { name: "Simple Graphs", category: "Science", level: "Primary", description: "Plotting basic bar charts and line graphs from observations", exams: ["11+ / Primary Excellence"] },
  { name: "Speed = Distance / Time", category: "Physics", level: "Middle School", description: "Calculating speed and rearranging the formula for distance and time", exams: ["13+ / Scholarship Track", "SAT Math"] },
  { name: "Density Calculations", category: "Physics", level: "Middle School", description: "Using density = mass / volume and solving simple problems", exams: ["13+ / Scholarship Track", "SAT Math"] },
  { name: "Temperature and Energy Changes", category: "Chemistry", level: "Middle School", description: "Reading thermometers and basic interpretation of heating graphs", exams: ["13+ / Scholarship Track"] },
  { name: "Forces and Acceleration", category: "Physics", level: "GCSE", description: "Using F = ma and interpreting motion graphs (velocity-time, distance-time)", exams: ["GCSE Maths Higher"] },
  { name: "Energy Calculations", category: "Physics", level: "GCSE", description: "Kinetic and potential energy calculations and efficiency formulas", exams: ["GCSE Maths Higher"] },
  { name: "Electric Circuits Calculations", category: "Physics", level: "GCSE", description: "Using V = IR and power equations in circuits", exams: ["GCSE Maths Higher"] },
  { name: "Moles and Stoichiometry", category: "Chemistry", level: "GCSE", description: "Calculating amounts of substances using molar mass and balanced equations", exams: ["GCSE Maths Higher"] },
  { name: "Radioactivity and Half-Life", category: "Physics", level: "GCSE", description: "Understanding exponential decay and half-life calculations", exams: ["GCSE Maths"] },
  { name: "Trigonometry in Physics", "category": "Physics", "level": "GCSE Higher", "description": "Resolving forces and using sine / cosine in vector problems", exams: ["GCSE Maths Higher"] },
  { name: "Gas Laws", "category": "Chemistry", "level": "GCSE Higher", "description": "Relationships between pressure, volume, and temperature using proportional reasoning", exams: ["GCSE Maths Higher"] },
  { name: "Gradient and Area in Graphs", "category": "Physics", "level": "GCSE Higher", "description": "Using gradients for acceleration and area under graphs for distance", exams: ["GCSE Maths Higher"] },
  { name: "SUVAT Equations", "category": "Physics", "level": "A-Level", "description": "Using kinematic equations for motion with constant acceleration", exams: ["A-Level Further Maths"] },
  { name: "Exponentials in Radioactive Decay", "category": "Physics", "level": "A-Level", "description": "Using exponential functions and logarithms to model decay", exams: ["A-Level Further Maths", "University STEM Foundation"] },
  { name: "Enthalpy Calculations", "category": "Chemistry", "level": "A-Level", "description": "Bond energies and Hess's Law calculations", exams: ["University STEM Foundation"] },
  { name: "Equilibrium Constants (Kc)", "category": "Chemistry", "level": "A-Level", "description": "Writing and solving equilibrium expressions mathematically", exams: ["University STEM Foundation"] },
  { name: "Statistical Analysis in Biology", "category": "Biology", "level": "A-Level", "description": "Using standard deviation and significance tests (e.g. t-test)", exams: ["University STEM Foundation"] },
  ...
  { name: "Understanding Roman Numerals", "category": "History", "level": "Primary", "description": "Translating and computing with Roman digits", exams: ["11+ / Primary Excellence"] },
  { name: "Money Mathematics", "category": "Arithmetic", "level": "Primary", "description": "Adding, subtracting, and giving change in diverse currencies", exams: ["11+ / Primary Excellence"] },
  { name: "Reflection and Symmetry", "category": "Geometry", "level": "Primary", "description": "Finding lines of symmetry in 2D shapes", exams: ["11+ / Primary Excellence"] },
  { name: "Reading Coordinates", "category": "Geometry", "level": "Primary", "description": "Navigating simple grids with (x, y)", exams: ["11+ / Primary Excellence"] },
  { name: "Volume of Prisms (Basic)", "category": "Geometry", "level": "Middle School", "description": "Lengths x Widths x Heights of cubes and cuboids", exams: ["13+ / Scholarship Track"] },
  { name: "Angle Bearings", "category": "Geometry", "level": "Middle School", "description": "Navigating maps using 3-figure degree bearings", exams: ["13+ / Scholarship Track"] },
  { name: "Conversion of Area & Volume Units", "category": "Arithmetic", "level": "Middle School", "description": "Squaring and cubing metric conversion factors", exams: ["GCSE Maths Higher"] },
  { name: "Hyperbolic Functions (Intro)", "category": "Calculus", "level": "A-Level Further", "description": "Introduction to sinh, cosh, and tanh functions", exams: ["A-Level Further Maths"] },
  { name: "Geometric Proofs with Circles", category: "Geometry", level: ["GCSE Higher", "AQA GCSE Further Maths"], description: "Advanced proofs using circle theorems and congruence", exams: ["GCSE Maths Higher", "AQA GCSE Further Maths"] },
  { name: "Polynomial Graphs (Higher Degree)", category: "Algebra", level: ["GCSE Higher", "AQA GCSE Further Maths"], description: "Sketching and analyzing graphs of degree 3 and 4", exams: ["GCSE Maths Higher", "AQA GCSE Further Maths"] }
];
